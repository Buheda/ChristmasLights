...
// Объединение со светомузыкой от AlexGyver
// Feniragon
// 1.0
...
#define NUM_LEDS      150          // Сколько светодиодов в гирлянде при первом включении
...
#define POWER_I       3000        // Ток блока питания в милиАмперах, автоматически управляет яркостью (пожалей свой блок питания!) 0 - выключить лимит

//////////////////////////////////////// Параметры программы
////
#define COLOR_MUSIC_AVAILABLE  1  // доступна ли светомузыка
...
#define AVAILABLE_MODES    2,4,9,14,16,20,26,33,39,40,41
...
#define MY_MODE    AVAILABLE_MODES// 0,1,2,4,5,9,10,11,14,16,17,18,19,21, 22, 28, 30, 32, 34, 36, 37, 38
